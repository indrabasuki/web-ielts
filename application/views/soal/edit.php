                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="form-group">
                            ...
                            <input placeholder="No Urut Soal" type="number" value="<?= $soal->urutan ?>" class="form-control" name="urutan">
                        ...
                        <label for="soal" class="control-label">Soal</label>
                            <div class="form-group">
                                <textarea name="soal"  id="ckeditor1" class="ckeditor" class="form-control"><?= $soal->soal ?></textarea>
                        ...
                        ?>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <textarea name="opsi_<?= $abj; ?>" id="opsi_<?= $abj; ?>" class="form-control ckeditor"><?= $soal->opsi_a?></textarea>
